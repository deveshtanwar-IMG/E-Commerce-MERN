...
import science from '/src/assets/images/client/science.svg'
import angular from '/src/assets/images/client/angular.svg'
import figma from '/src/assets/images/client/figma.svg'
import Image_01 from '/src/assets/images/avatar/01.jpg'
import Image_02 from '/src/assets/images/avatar/02.jpg'
import Image_03 from '/src/assets/images/avatar/03.jpg'
import Image_04 from '/src/assets/images/avatar/04.jpg'
import Image_07 from '/src/assets/images/element/07.png'
...
const Home = () => {
  ...
  return (
    <>
              ...
              <div className="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block" style={{ background: 'url(assets/images/pattern/01.png)no-repeat center center', backgroundSize: 'cover' }}>
                ...
                <ul className="avatar-group mb-0">
                  <li className="avatar avatar-sm">
                    <img className="avatar-img rounded-circle border-white" src={Image_01} alt="avatar" />
                  </li>
                  <li className="avatar avatar-sm">
                    <img className="avatar-img rounded-circle border-white" src={Image_02} alt="avatar" />
                  </li>
                  <li className="avatar avatar-sm">
                    <img className="avatar-img rounded-circle border-white" src={Image_03} alt="avatar" />
                  </li>
                  <li className="avatar avatar-sm">
                    <img className="avatar-img rounded-circle border-white" src={Image_04} alt="avatar" />
                  </li>
                  <li className="avatar avatar-sm">
        ...
        <div className="container">
          ...
          <div className="row mb-4">
            <div className="col-lg-8 mx-auto text-center">
              <h2 className="fs-1">Most Popular Categories</h2>
              <p className="mb-0">Choose from hundreds of items from global super market chain</p>
            </div>
          </div>
          ...
          <ul className="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab" role="tablist">
            ...
            <li className="nav-item me-2 me-sm-5">
              <button className="nav-link mb-2 mb-md-0 active" id="course-pills-tab-5" data-bs-toggle="pill" data-bs-target="#course-pills-tabs-5" type="button" role="tab" aria-controls="course-pills-tabs-5" aria-selected="false" onClick={() => { allHandler() }}>All</button>
            </li>
            {categories.map((val) => {
              return (
                <li className="nav-item me-2 me-sm-5" key={val._id}>
                  <button className="nav-link mb-2 mb-md-0" id="course-pills-tab-5" data-bs-toggle="pill" data-bs-target="#course-pills-tabs-5" type="button" role="tab" aria-controls="course-pills-tabs-5" aria-selected="false" onClick={() => { categoryHandler(val._id) }}>{val.title}</button>
                </li>
              )
            })}
          </ul>
          ...
          {subCategories && subCategories.length > 0 ?
            <ul className="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab" role="tablist">
              ...
              {subCategories.map((val) => {
                return (
                  <li className="nav-item me-2 me-sm-5" key={val._id}>
                    <button className="nav-link mb-2 mb-md-0" id="course-pills-tab-5" data-bs-toggle="pill" data-bs-target="#course-pills-tabs-5" type="button" role="tab" aria-controls="course-pills-tabs-5" aria-selected="false" onClick={() => { productHandler(val._id) }}>{val.title}</button>
                  </li>
                )
              })}
            </ul>
      ...
      {/* <!-- Tabs content START --> */}
      <div className="tab-content container" id="course-pills-tabContent">
        {/* <!-- Content START --> */}
